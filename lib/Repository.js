        ...
        master : function (h) {
          var options = new Options({
            ...
            type : {
              ...
              type : {
                enumerable : ["findByUuid", "findByUuidSeveral", "findByUuidMaybe", "find", "save", "remove" ]
              },
              args : {
          ...
          cont.then(function () {
            ...
            for (var i = 0; i < keys.length; i++) {
              var v = arguments[i][0];
              // > Checking for length is bad. How to identify if it's an arguments object?
              res[keys[i]] = v && v.length ? toArray(v) : v;
            }
